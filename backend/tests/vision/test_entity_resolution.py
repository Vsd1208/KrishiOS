...
def test_entity_resolution_vision_crop():
    ...
    ext_entity = ExtractedEntity(raw_text="rice", entity_type="crop", confidence=1.0)
...
def test_entity_resolution_vision_symptom():
    ...
    ext_entity = ExtractedEntity(raw_text="yellowing leaves", entity_type="symptom", confidence=0.8)
    res_entity = resolver.resolve(ext_entity)
